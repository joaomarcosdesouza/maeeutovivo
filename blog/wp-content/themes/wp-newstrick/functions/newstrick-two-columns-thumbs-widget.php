...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CT Two Columns Thumbs Widget
...
class CT_2Columns_Widget extends WP_Widget {
	...
	{
		/* Widget settings. */
		$widget_ops = array('classname' => 'ct_2columns_widget', 'description' => __( 'Two Columns Thumbs Widget (show recent posts).' , 'color-theme-framework' ) );
		
		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'ct_2columns_widget' );
		
		/* Create the widget. */
		parent::__construct( 'ct_2columns_widget', __( 'CT: Two Columns Magazine Widget' , 'color-theme-framework' ), $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		$background = $instance['background'];
	 	...
	 	global $data, $post, $ct_video_height, $ct_is_magazine_row;
		...
		if ( $title ) {
			echo "\n<!-- START TWO COLUMNS THUMBS WIDGET -->\n";
...
<!-- ************* Second Column **************** -->
		...
		<p>
			<label for="<?php echo $this->get_field_id('video_height2'); ?>"><?php _e( 'Height of embedded video or audio  (px):' , 'color-theme-framework' ); ?></label>
			<input type="number" min="1" max="1000" class="widefat" id="<?php echo $this->get_field_id('video_height2'); ?>" name="<?php echo $this->get_field_name('video_height2'); ?>" value="<?php echo $instance['video_height2']; ?>" />
		</p>

	...
	<div class="row-fluid">
		<div class="span12 button-blog">
			...
			<div class="category-title">
				<h1 class="entry-title"><?php _e('Search Results for', 'color-theme-framework') ?> &#8220;<?php the_search_query(); ?>&#8221;</h1>
				...
				<?php 
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('entry-post'); ?>>	
	    				...
	    				// if Audio post format
	  					...
	  					elseif( ($ct_format == 'gallery') && ( $ct_pagination_type != 'Show more button' ) ): get_template_part( 'includes/widget', $ct_format );

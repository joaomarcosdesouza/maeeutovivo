...
var scrolltotop={
	...
	controlHTML: '<!-- TO TOP --><div class="widget-title bottom-shadow" style="background:#ff0000; min-width:inherit;"><h2>To Top</h2><div class="arrow-down" style="border-top-color:#ff0000;"></div><!-- .arrow-down --><div class="to-top"></div><!-- .to-top --></div><!-- .widget-title -->', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
	...
	init:function(){
		jQuery(document).ready(function($){
			...
			mainobj.$control=$('<div id="topcontrol">'+mainobj.controlHTML+'</div>')
				...
				.appendTo('footer .totop-container')

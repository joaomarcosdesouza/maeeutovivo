...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'desc' => __('Select a custom background repeat for the uploaded image.', 'color-theme-framework'),
		),
		array(
			...
			'desc' => __('Select a custom background position for the uploaded image.', 'color-theme-framework'),
		),
		array(
			...
			'desc' => __('Select a custom background attachment for the uploaded image.', 'color-theme-framework'),
		),
		array(
...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'desc'  => __('Enter Video ID', 'color-theme-framework'),
			'type'  => 'text',
			'std'   => '',
			'clone' => false,
		),	
        array(  
			'name'     => __('Type of Video Thumb', 'color-theme-framework'),
			...
			'type'     => 'select',
			'options'  => array(
				'player' => __('Player', 'color-theme-framework'),
				'featured' => __('Featured', 'color-theme-framework'),
				'auto' => 'Auto',
			),
			'multiple' => false,
        ),  
...
$meta_boxes[] = array(
	...
	'fields' => array(
		array(
			'name'		=> __('Type of Audio Thumb (for Blog, Widgets, etc.)', 'color-theme-framework'),
			'desc'		=> __('Choose the type of thumbnail : iframe player or featured image', 'color-theme-framework' ),
			'id'		=> "{$prefix}post_audio_thumb",
			'type'		=> 'select',
			'options'	=> array(
				'player'	=> __('Iframe Player', 'color-theme-framework'),
				'featured' => __('Featured Image', 'color-theme-framework'),
			),
			'multiple' => false,
		),
		array(
